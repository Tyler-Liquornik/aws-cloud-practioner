...
![Users and Groups](images/iam/users-and-groups.png)
...
![Creating a User](images/iam/creating-a-user.png)
...
![Policy Inheritance](policy-inheritance.png)
...
![Created User](images/iam/created-user.png)
...
![Session Metadata](images/iam/session-metadata.png)
...
![Access Denied](images/iam/access-denied.png)
...
![CloudShell](images/iam/cloudshell.png)
...
![Creating a Role](images/iam/creating-a-role.png)
...
![Credentials Report](images/iam/credentials-report.png)
...
![Last Accessed](images/iam/last-accessed.png)