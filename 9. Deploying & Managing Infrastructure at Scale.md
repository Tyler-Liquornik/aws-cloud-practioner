...
We've seen some managed services already like Lambda, and RDS, but not a comprehensive one that ties together all the common infrastructure services together. **Elastic Beanstalk** is a comprehensive managed PaaS that creates the basic infrastructure to scale most apps. 
...
- 3 architecture models based on CloudFormation templates
	...
	- ALB + ASG
	- only ASG, no ALB
- Monitoring thorough CloudWatch metrics
