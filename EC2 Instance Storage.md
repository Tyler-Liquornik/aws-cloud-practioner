...
If we check our instance from the [EC2](AWS%20EC2.md) section, we'll see in the *Storage* tab that it already has an 8GB EBS volume that was attached to it by default
